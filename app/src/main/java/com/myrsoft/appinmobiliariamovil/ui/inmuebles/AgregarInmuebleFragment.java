...
public class AgregarInmuebleFragment extends Fragment {
    ...
    private String[] opcionesTipo = {"Casa", "Departamento", "Depósito", "Local comercial"};
    private String[] opcionesUso = {"Residencial", "Comercial"};
    ...
    private void inicializarSpinners() {
        ...
        binding.etTipo.setAdapter(adapterTipo);

        ArrayAdapter<String> adapterUso = new ArrayAdapter<>(
            requireContext(), android.R.layout.simple_dropdown_item_1line, 
            opcionesUso
        );
        binding.etUso.setAdapter(adapterUso);

        // VALORES POR DEFECTO (activados)
    binding.etTipo.setText(opcionesTipo[0], false);  // "Casa"
    binding.etUso.setText(opcionesUso[0], false);    // "Residencial"
